...
export function TransferProgress({ meta, progress, label }: TransferProgressProps) {
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs font-light text-muted-foreground">{formatBytes(meta.size)}</p>
        </div>
      </div>
      ...
      <div className="relative h-1.5 w-full overflow-hidden rounded-full bg-muted">
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 0 12px var(--primary-glow), 0 0 4px var(--primary-glow)",
          }}
        >
          {/* Shimmer overlay */}
          <div
